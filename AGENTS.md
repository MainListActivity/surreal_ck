...
| Folder                 | Description                                                                                                                              |
| ---------------------- | ---------------------------------------------------------------------------------------------------------------------------------------- |
| `src/main/ai/mastra`           | Entry point for all Mastra-related code and configuration.                                                                               |
| `src/main/ai/mastra/agents`    | Define and configure your agents - their behavior, goals, and tools.                                                                     |
| `src/main/ai/mastra/workflows` | Define multi-step workflows that orchestrate agents and tools together.                                                                  |
| `src/main/ai/mastra/tools`     | Create reusable tools that your agents can call                                                                                          |
| `src/main/ai/mastra/mcp`       | (Optional) Implement custom MCP servers to share your tools with external agents                                                         |
| `src/main/ai/mastra/scorers`   | (Optional) Define scorers for evaluating agent performance over time                                                                     |
...
| File                  | Description                                                                                                       |
| --------------------- | ----------------------------------------------------------------------------------------------------------------- |
| `src/mail/ai/index.ts` | Central entry point where you configure and initialize Mastra.                                                    |
| `.env`        | Template for environment variables - copy and rename to `.env` to add your secret [model provider](/models) keys. |
...
- Register new agents, tools, workflows, and scorers in `src/main/ai/index.ts`
