...
export type { CapabilityBlockedReason, CapabilityKey, CapabilityState, } from "./capabilities";
...
export type AppErrorCode = "NOT_AUTHENTICATED" | "OFFLINE_READ_ONLY" | "NOT_IMPLEMENTED" | "BOOTSTRAP_REQUIRED" | "VALIDATION_ERROR" | "NOT_FOUND" | "FORBIDDEN" | "INTERNAL_ERROR" | "SQL_MUTATION_WARNING" | "OFFLINE_DDL_FORBIDDEN" | "REMOTE_DDL_FAILED" | "TEMPLATE_REJECTED";
...
export declare const SendAiMessageRequestSchema: z.ZodObject<{
    message: z.ZodObject<{
        id: z.ZodString;
        role: z.ZodEnum<{
            user: "user";
        ...
        context: z.ZodObject<{
            route: z.ZodObject<{
                ...
                workbookId: z.ZodOptional<z.ZodString>;
                sheetId: z.ZodOptional<z.ZodString>;
                folderId: z.ZodOptional<z.ZodString>;
                templateKey: z.ZodOptional<z.ZodString>;
            }, z.core.$strip>;
            workbook: z.ZodNullable<z.ZodObject<{
                id: z.ZodString;
                name: z.ZodString;
            }, z.core.$strip>>;
            sheet: z.ZodNullable<z.ZodObject<{
                id: z.ZodString;
                label: z.ZodString;
                tableName: z.ZodString;
            }, z.core.$strip>>;
            selectedRow: z.ZodNullable<z.ZodObject<{
                id: z.ZodString;
                label: z.ZodString;
                visibleValues: z.ZodRecord<z.ZodString, z.ZodUnknown>;
            }, z.core.$strip>>;
            contextHint: z.ZodString;
        }, z.core.$strip>;
    }, z.core.$strip>;
    streamId: z.ZodString;
    composerMode: z.ZodOptional<z.ZodEnum<{
        chat: "chat";
...
export declare const SendAiMessageResponseSchema: z.ZodObject<{
    message: z.ZodObject<{
        id: z.ZodString;
        role: z.ZodEnum<{
            user: "user";
...
export type AiStructuredIntent = AppNavigationIntent | ToolNavigationIntent | DashboardDraftIntent | LegacyDashboardDraftIntent | RowPatchProposal | RowPatchIntent | ResourceDraftIntent;
...
export declare const AiStructuredIntentSchema: z.ZodUnion<readonly [z.ZodObject<{
    ...
    type: z.ZodLiteral<"open-workbook">;
    workbookId: z.ZodString;
    label: z.ZodOptional<z.ZodString>;
}, z.core.$strip>, z.ZodObject<{
    type: z.ZodLiteral<"open-dashboard">;
    dashboardId: z.ZodString;
    label: z.ZodOptional<z.ZodString>;
}, z.core.$strip>, z.ZodObject<{
    type: z.ZodLiteral<"open-record">;
    workbookId: z.ZodString;
    sheetId: z.ZodString;
    ...
    type: z.ZodLiteral<"dashboard-draft">;
    title: z.ZodString;
    description: z.ZodString;
    widgetSpec: z.ZodObject<{
        sourceTables: z.ZodArray<z.ZodString>;
    ...
    draft: z.ZodObject<{
        ...
        resultContract: z.ZodEnum<{
            single_value: "single_value";
            category_breakdown: "category_breakdown";
            time_series: "time_series";
            table_rows: "table_rows";
        }>;
        compiledSql: z.ZodOptional<z.ZodString>;
        builderSpec: z.ZodOptional<z.ZodObject<{
            sourceTables: z.ZodArray<z.ZodString>;
            baseTable: z.ZodString;
            metric: z.ZodObject<{
                op: z.ZodEnum<{
        ...
        displaySpec: z.ZodOptional<z.ZodRecord<z.ZodString, z.ZodUnknown>>;
    ...
    type: z.ZodLiteral<"rowPatch">;
    sheetId: z.ZodString;
    rowId: z.ZodString;
    patch: z.ZodRecord<z.ZodString, z.ZodUnknown>;
}, z.core.$strip>, z.ZodObject<{
    type: z.ZodLiteral<"resource-draft">;
    draft: z.ZodObject<{
        workspaceId: z.ZodString;
        ...
        structuredPayload: z.ZodOptional<z.ZodRecord<z.ZodString, z.ZodUnknown>>;
        quality: z.ZodEnum<{
        ...
        sourceTrust: z.ZodOptional<z.ZodString>;
...
export declare const ExecuteAiActionRequestSchema: z.ZodObject<{
    intent: z.ZodUnion<readonly [z.ZodObject<{
        type: z.ZodLiteral<"navigate">;
        screen: z.ZodString;
        workbookId: z.ZodOptional<z.ZodString>;
        sheetId: z.ZodOptional<z.ZodString>;
...
export declare const ExecuteAiActionResponseSchema: z.ZodObject<{
    ok: z.ZodBoolean;
...
export declare const AiProgressEventSchema: z.ZodDiscriminatedUnion<[z.ZodObject<{
    kind: z.ZodLiteral<"routing">;
    runId: z.ZodString;
}, z.core.$strip>, z.ZodObject<{
    kind: z.ZodLiteral<"agent-step">;
    runId: z.ZodString;
...
export declare const AiRunCancelledEventSchema: z.ZodObject<{
    runId: z.ZodString;
    sessionId: z.ZodOptional<z.ZodString>;
    reason: z.ZodEnum<{
        "user-cancelled": "user-cancelled";
        "research-window-closed": "research-window-closed";
    }>;
    message: z.ZodString;
}, z.core.$strip>;
export declare const ResolvedRecordSchema: z.ZodObject<{
    id: z.ZodString;
    label: z.ZodString;
}, z.core.$strip>;
...
export declare const WorkflowSuspendedEventSchema: z.ZodDiscriminatedUnion<[z.ZodObject<{
    kind: z.ZodLiteral<"ambiguous-candidates">;
    runId: z.ZodString;
    candidates: z.ZodArray<z.ZodObject<{
        id: z.ZodString;
        label: z.ZodString;
    ...
    kind: z.ZodLiteral<"resource-candidates">;
    runId: z.ZodString;
    candidates: z.ZodArray<z.ZodObject<{
        id: z.ZodString;
        label: z.ZodString;
    ...
    kind: z.ZodLiteral<"manual-research">;
    runId: z.ZodString;
    ...
    kind: z.ZodLiteral<"await-write-confirm">;
    runId: z.ZodString;
    intent: z.ZodUnion<readonly [z.ZodObject<{
        type: z.ZodLiteral<"navigate">;
        screen: z.ZodString;
...
declare const ResumeDecisionSchema: z.ZodDiscriminatedUnion<[z.ZodObject<{
    kind: z.ZodLiteral<"candidate-chosen">;
    candidateId: z.ZodString;
}, z.core.$strip>, z.ZodObject<{
    kind: z.ZodLiteral<"candidate-cancelled">;
}, z.core.$strip>, z.ZodObject<{
    kind: z.ZodLiteral<"write-confirmed">;
}, z.core.$strip>, z.ZodObject<{
    kind: z.ZodLiteral<"write-rejected">;
}, z.core.$strip>, z.ZodObject<{
    kind: z.ZodLiteral<"resource-candidates-chosen">;
    resourceIds: z.ZodArray<z.ZodString>;
}, z.core.$strip>, z.ZodObject<{
    kind: z.ZodLiteral<"resource-candidates-manual-research">;
}, z.core.$strip>, z.ZodObject<{
    kind: z.ZodLiteral<"manual-research-completed">;
    resourceIds: z.ZodArray<z.ZodString>;
}, z.core.$strip>], "kind">;
export type ResumeDecision = z.infer<typeof ResumeDecisionSchema>;
export declare const ResumeAiWorkflowRequestSchema: z.ZodObject<{
    runId: z.ZodString;
...
export declare const CancelAiWorkflowRequestSchema: z.ZodObject<{
    runId: z.ZodString;
    sessionId: z.ZodOptional<z.ZodString>;
...
export type ChatStreamEvent = {
    ...
    kind: "suspend";
    runId: string;
    payload: WorkflowSuspendedEvent;
} | {
    kind: "done";
    runId: string;
    message: AiChatMessage;
...
export declare const CHAT_STREAM_TERMINAL_RETENTION_MS = 60000;
...
export type FilterOp = "eq" | "neq" | "gt" | "gte" | "lt" | "lte" | "contains" | "not_contains" | "in" | "is_null" | "is_not_null";
...
export type SaveResearchResourceRequest = Omit<SaveResourceRequest, "workspaceId" | "resourceType" | "researchSessionId"> & {
...
export type DashboardBuilderMetricOp = "count" | "count_distinct" | "sum" | "avg" | "min" | "max";
export type DashboardBuilderFilterOp = "eq" | "neq" | "gt" | "gte" | "lt" | "lte" | "contains" | "in" | "is_null" | "is_not_null";
...
export type DashboardNormalizedResult = DashboardSingleValueResult | DashboardCategoryBreakdownResult | DashboardTimeSeriesResult | DashboardTableRowsResult;
...
export interface AppRPC extends LegacyRPCSchema {
    bun: {
        requests: {
            ...
            getAppBootstrap: {
                params: Record<string, never>;
                response: Result<AppBootstrap>;
            };
            getSyncStatusV2: {
                params: Record<string, never>;
                response: Result<SyncStatusV2DTO>;
            };
            triggerSyncRebuild: {
                params: Record<string, never>;
                response: Result<SyncStatusV2DTO>;
            ...
            reconnectRemote: {
                params: Record<string, never>;
                response: Result<ReconnectRemoteResponse>;
            };
            getSettings: {
                params: Record<string, never>;
                response: Result<GetSettingsResponse>;
            };
            saveSettings: {
                params: SaveSettingsRequest;
                response: Result<SaveSettingsResponse>;
            };
            sendAiMessage: {
                params: SendAiMessageRequest;
                response: Result<SendAiMessageResponse>;
            };
            resumeAiWorkflow: {
                params: ResumeAiWorkflowRequest;
                response: Result<ResumeAiWorkflowResponse>;
            };
            cancelAiWorkflow: {
                params: CancelAiWorkflowRequest;
                response: Result<CancelAiWorkflowResponse>;
            };
            executeAiAction: {
                params: ExecuteAiActionRequest;
                response: Result<ExecuteAiActionResponse>;
            };
            listWorkbooks: {
                params: ListWorkbooksRequest;
                response: Result<ListWorkbooksResponse>;
            };
            createBlankWorkbook: {
                params: CreateBlankWorkbookRequest;
                response: Result<CreateBlankWorkbookResponse>;
            };
            listFolders: {
                params: ListFoldersRequest;
                response: Result<ListFoldersResponse>;
            };
            createFolder: {
                params: CreateFolderRequest;
                response: Result<CreateFolderResponse>;
            };
            moveFolder: {
                params: MoveFolderRequest;
                response: Result<MoveFolderResponse>;
            };
            moveWorkbook: {
                params: MoveWorkbookRequest;
                response: Result<MoveWorkbookResponse>;
            };
            listTemplates: {
                params: Record<string, never>;
                response: Result<ListTemplatesResponse>;
            };
            createWorkbookFromTemplate: {
                params: CreateWorkbookFromTemplateRequest;
                response: Result<CreateWorkbookFromTemplateResponse>;
            };
            getWorkbookData: {
                params: GetWorkbookDataRequest;
                response: Result<GetWorkbookDataResponse>;
            };
            upsertRows: {
                params: UpsertRowsRequest;
                response: Result<UpsertRowsResponse>;
            };
            deleteRows: {
                params: DeleteRowsRequest;
                response: Result<DeleteRowsResponse>;
            };
            renameWorkbook: {
                params: RenameWorkbookRequest;
                response: Result<RenameWorkbookResponse>;
            };
            updateSheetFields: {
                params: UpdateSheetFieldsRequest;
                response: Result<UpdateSheetFieldsResponse>;
            };
            createSheet: {
                params: CreateSheetRequest;
                response: Result<CreateSheetResponse>;
            };
            renameSheet: {
                params: RenameSheetRequest;
                response: Result<RenameSheetResponse>;
            };
            resolveReferences: {
                params: ResolveReferencesRequest;
                response: Result<ResolveReferencesResponse>;
            };
            listReferenceTargets: {
                params: Record<string, never>;
                response: Result<ListReferenceTargetsResponse>;
            };
            searchReferenceCandidates: {
                params: SearchReferenceCandidatesRequest;
                response: Result<SearchReferenceCandidatesResponse>;
            };
            getTableSchema: {
                params: GetTableSchemaRequest;
                response: Result<GetTableSchemaResponse>;
            };
            saveResource: {
                params: SaveResourceRequest;
                response: Result<SaveResourceResponse>;
            };
            saveResearchResource: {
                params: SaveResearchResourceRequest;
                response: Result<SaveResourceResponse>;
            };
            getResourceDetail: {
                params: GetResourceDetailRequest;
                response: Result<ResourceDetailResponse>;
            };
            searchResources: {
                params: SearchResourcesRequest;
                response: Result<SearchResourcesResponse>;
            };
            createResearchSession: {
                params: CreateResearchSessionRequest;
                response: Result<ResearchSessionResponse>;
            };
            getResearchSession: {
                params: GetResearchSessionRequest;
                response: Result<ResearchSessionResponse>;
            };
            completeResearchSession: {
                params: CompleteResearchSessionRequest;
                response: Result<ResearchSessionResponse>;
            };
            cancelResearchSession: {
                params: CancelResearchSessionRequest;
                response: Result<ResearchSessionResponse>;
            };
            retryResourceEmbedding: {
                params: RetryResourceEmbeddingRequest;
                response: Result<RetryResourceEmbeddingResponse>;
            };
            openResearchWindow: {
                params: OpenResearchWindowRequest;
                response: Result<OpenResearchWindowResponse>;
            };
            generateResourceDraft: {
                params: GenerateResourceDraftRequest;
                response: Result<GenerateResourceDraftResponse>;
            };
            listDashboardPages: {
                params: ListDashboardPagesRequest;
                response: Result<ListDashboardPagesResponse>;
            };
            getDashboardPage: {
                params: GetDashboardPageRequest;
                response: Result<GetDashboardPageResponse>;
            };
            createDashboardPage: {
                params: CreateDashboardPageRequest;
                response: Result<CreateDashboardPageResponse>;
            };
            renameDashboardPage: {
                params: RenameDashboardPageRequest;
                response: Result<RenameDashboardPageResponse>;
            };
            saveDashboardPageLayout: {
                params: SaveDashboardPageLayoutRequest;
                response: Result<SaveDashboardPageLayoutResponse>;
            };
            listDashboardViews: {
                params: ListDashboardViewsRequest;
                response: Result<ListDashboardViewsResponse>;
            };
            createDashboardView: {
                params: CreateDashboardViewRequest;
                response: Result<CreateDashboardViewResponse>;
            };
            updateDashboardView: {
                params: UpdateDashboardViewRequest;
                response: Result<UpdateDashboardViewResponse>;
            };
            previewDashboardView: {
                params: PreviewDashboardViewRequest;
                response: Result<PreviewDashboardViewResponse>;
            };
            refreshDashboardView: {
                params: RefreshDashboardViewRequest;
                response: Result<RefreshDashboardViewResponse>;
            };
            refreshDashboardPage: {
                params: RefreshDashboardPageRequest;
                response: Result<RefreshDashboardPageResponse>;
            };
        };
        messages: {
            log: {
